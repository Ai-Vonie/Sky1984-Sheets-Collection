...
0.  **Where to find MIDI files:** There are many ways to search for or generate MIDI files, but the easiest option is to check out the **[dl-librescore](https://github.com/LibreScore/dl-librescore)** repository.
