...
0.  **Где брать MIDI-файлы:** Существует множество способов поиска и генерации MIDI-файлов, но самый простой вариант — ознакомиться с репозиторием **[dl-librescore](https://github.com/LibreScore/dl-librescore)**.
